...
async def documentation_generator(ctx: Context) -> str:
    ...
    try:
        result = await ctx.elicit(
            messge="Please provide the subject file name and the documentation file name",
        ...
        prompt = f"""You are an expert tecnical writer and documentation specialist. Create documentation for the following code file:
            File: {file_path}
            Language (file suffix): {language or "Unknown"}
            Current code:
                '''
